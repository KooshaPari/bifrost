...
func (fp *FallbackPlugin) PostHook(
	...
	// Mark error as allowing fallbacks
	if err != nil {
		allowFallbacks := true
		err.AllowFallbacks = &allowFallbacks
	}
...
func (fp *FallbackPlugin) shouldRetry(err *schemas.BifrostError, attempt int, strategy FallbackStrategy) bool {
