...
-- name: CreateDocumentChunkFull :one
INSERT INTO document_chunks (
    doc_id, chunk_index, content, summary, short_summary, medium_summary,
    embedding, token_count, importance
)
...
-- name: CreateConversationSegmentFull :one
INSERT INTO conversation_segments (
    session_id, conversation_id, segment_index, content, summary, short_summary,
    embedding, token_count, importance, raw_storage_key
)
...
-- name: UpdateChunkSummaries :exec
